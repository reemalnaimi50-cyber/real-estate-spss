...
# ================= APARTMENT SALE =================
    ...
    price = (10.738 + 0.473*area_log + 0.042*wc -
             0.003*street_width + 0.051*livings -
             0.007*age - 0.006*beds)
...
# ================= HOUSE RENT =================
    ...
    price = (8.080 + 0.512*area_log + 0.338*f -
             0.023*distance_to_sea + 0.078*livings)
...
# ================= APARTMENT RENT =================
    ...
    price = (3.429 + 1.796*rent_period + 0.360*wc +
